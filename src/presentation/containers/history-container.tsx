...
export function HistoryContainer() {
  const [history, setHistory] = useState<RecommendationHistory[]>(() => getHistory())
  const [favIds, setFavIds] = useState<string[]>(() => getFavorites())
  const [visIds, setVisIds] = useState<string[]>(() => getVisited())
  const [favRestaurants, setFavRestaurants] = useState<Restaurant[]>(() => getRestaurantsFromHistory(getFavorites()))
  const [visRestaurants, setVisRestaurants] = useState<Restaurant[]>(() => getRestaurantsFromHistory(getVisited()))
  const [recentRestaurants, setRecentRestaurants] = useState<Restaurant[]>(() => getRestaurantsFromHistory(getRecentViews()))
