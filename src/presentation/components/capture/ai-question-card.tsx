        ...
        {isSelectMode ? (
          <>
              ...
              <button
                ...
                className={`rounded-xl border px-3 py-2.5 text-left text-sm transition-colors ${
                  value === option
                    ...
                    : "border-orange-200 bg-card dark:bg-neutral-100 text-foreground hover:border-orange-300"
                }`}
              >
                {option}
              </button>
            ...
            <button
              ...
              className="flex items-center gap-1.5 self-start text-xs text-neutral-400 hover:text-neutral-600"
            >
          ...
          <>
            <textarea
              ...
              rows={3}
              className="w-full rounded-xl border border-orange-200 bg-card dark:bg-neutral-100 px-3 py-2.5 text-sm outline-none focus:border-orange-400 resize-none"
            />
