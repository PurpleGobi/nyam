 ...
 */
function getWeights(recordCount: number): { taste: number; style: number; quality: number; novelty: number } {
  if (recordCount < 5) return { taste: 0.10, style: 0.10, quality: 0.60, novelty: 0.20 }
