...
XP_TABLE = {
    RecordQuality.NAME_ONLY: 1,
    RecordQuality.WITH_SCORE: 3,
    RecordQuality.WITH_PHOTO: 10,
    RecordQuality.FULL: 15,
}

SOCIAL_XP = {
    "bubble_share": 1,
    "like_received": 1,
    "follower_gained_bubble": 2,
    "follower_gained_personal": 2,
    "mutual_follow": 3,
}
