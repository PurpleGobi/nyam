...
- [ ] 카메라 촬영 UI + AI 인식 경로 (촬영→OCR/Vision→pre-fill)
- [ ] 검색 UI + 자동완성
- [ ] 식당 검색 (Nyam DB → 외부 API 폴백)
- [ ] 와인 검색 (Nyam DB → 라벨 OCR 폴백)
- [ ] 사진 EXIF GPS 검증 (반경 200m)
- [ ] 신규 식당/와인 등록 플로우
- [ ] FAB(+)→카메라/검색→선택→기록 풀플로우 연결
